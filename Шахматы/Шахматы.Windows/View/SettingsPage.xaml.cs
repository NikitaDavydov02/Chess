...
namespace Шахматы.View
{
    ...
    public sealed partial class SettingsPage : Page
    {
        ...
        SettingsDesignOfFigureViewModel viewModel;
        public SettingsPage()
        {
            ...
            viewModel = new SettingsDesignOfFigureViewModel();
            DataContext = viewModel;
            //languageBox.Items.Add("English");
            //languageBox.Items.Add("Русский");
            algorithmBox.Items.Add("Классический");
            designOfPiecesBox.Items.Add("Стандартный");
        }
        ...
        private void algorithmBox_DropDownClosed(object sender, object e)
        {
            if (algorithmBox.SelectionBoxItem.ToString() == "Классический")
                discription.Text = "Данный алгоритм высчитывает приорететность всех возможных ходов,\r\n исходя из выигрышности их продолжений,\r\n и делает наиболее выгодный из них.\r\n Требует много вычислительных ресурсов.";
        }

        private void designOfPiecesBox_DropDownClosed(object sender, object e)
        {
            UpdateFigures(designOfPiecesBox.SelectedItem.ToString());
        }
        private void UpdateFigures(string design)
        {
            viewModel.UpdateFigures();
        }
    }
}
